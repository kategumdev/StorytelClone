...
class LargeRectCoversTableViewCell: UITableViewCell {
    ...
    static let itemSize: CGSize = {
        ...
        let widthForContent =
        contentViewWidth - ((horzPadding * 2) + Constants.commonHorzPadding + CGFloat(visiblePartOfThirdCover))
    ...
    private let collectionView: UICollectionView = {
        ...
        collectionView.register(
            LargeBookCollectionViewCell.self,
            forCellWithReuseIdentifier: LargeBookCollectionViewCell.identifier)
...
extension LargeRectCoversTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(
        ...
        guard let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: LargeBookCollectionViewCell.identifier,
            for: indexPath) as? LargeBookCollectionViewCell else { return UICollectionViewCell()}
