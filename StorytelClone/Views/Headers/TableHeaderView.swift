...
class TableHeaderView: UIView {
    ...
    private lazy var bookTitleForSimilarLabel = UILabel.createLabelWith(
    ...
    lazy var stackTopAnchorConstraint =
    stackView.topAnchor.constraint(equalTo: topAnchor, constant: 19)
    lazy var stackBottomAnchorConstraint =
    ...
    private func applyConstraints() {
        ...
        NSLayoutConstraint.activate([
            stackView.leadingAnchor.constraint(
                ...
                constant: stackLeadingAndTrailingConstant),
            stackView.trailingAnchor.constraint(
                equalTo: trailingAnchor,
                constant: -stackLeadingAndTrailingConstant),
            stackView.widthAnchor.constraint(
                equalTo: widthAnchor,
                constant: -stackLeadingAndTrailingConstant * 2)
        ])
