...
struct Book: Title {
    ...
    init(title: String, authors: [Author], coverImage: UIImage?, largeCoverImage: UIImage? = nil, titleKind: TitleKind, overview: String = "", category: ButtonCategory, rating: Double = 4.5, duration: String = "5h 5m", language: Language = .spanish, narrators: [Narrator]? = nil) {
        self.title = title
