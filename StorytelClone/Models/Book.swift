    ...
    static func createBooksFrom(bookModels: [BookModel]) -> [Book] {
        ...
        for bookModel in bookModels {
            ...
            let book = Book(
                ...
                coverImage: nil,
                titleKind: .ebook,
                description: bookModel.volumeInfo.description ?? "This book has no description",
                category: .ebooks,
