...
//    static let books = [book1, book2, book3, book4, book5, book6, book7, book8, book9, book10]
    ...
    static let book22 = Book(title: "La travesía final", authors: [Storyteller.pabloToledo], coverImage: UIImage(named: "image22"), titleKind: .ebook, category: .novela, rating: 4.7, tags: Tag.tags)
