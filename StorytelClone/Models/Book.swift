...
//    static let books = [book1, book2, book3, book4, book5, book6, book7, book8, book9, book10]
    ...
    static let posterBook =  Book(title: "Modo Noche", authors: [Storyteller.brunoLopez, Storyteller.pabloToledo], coverImage: UIImage(named: "modoNoche"), titleKind: .audiobook, category: .thrillerYHorror)
    
    static let book1 = Book(title: "The city of brass", authors: [Storyteller.shannonChakraborty], coverImage: UIImage(named: "image1"), titleKind: .audiobook, overview: "Discover this spellbinding debut from S.A. Chakraborty.\n\n\n‘An extravagant feast of a book – spicy and bloody, dizzyingly magical, and still, somehow, utterly believable’ Laini Taylor, Sunday Times and New York Times bestselling author\n\n\nAmong the bustling markets of eighteenth century Cairo, the city’s outcasts eke out a living swindling rich Ottoman nobles and foreign invaders alike.\n\nBut alongside this new world the old stories linger. Tales of djinn and spirits. Of cities hidden among the swirling sands of the desert, full of enchantment, desire and riches. Where magic pours down every street, hanging in the air like dust.\n\nMany wish their lives could be filled with such wonder, but not Nahri. She knows the trades she uses to get by are just tricks and sleights of hand: there’s nothing magical about them. She only wishes to one day leave Cairo, but as the saying goes…\n\nBe careful what you wish for.", category: .novela, tags: Tag.twoTags, isAddedToBookshelf: true)
    
    static let book2 = Book(title: "The simple wild", authors: [Storyteller.tucker], coverImage: UIImage(named: "image2"), titleKind: .audioBookAndEbook, overview: "City girl Calla Fletcher attempts to reconnect with her estranged father, and unwittingly finds herself torn between her desire to return to the bustle of Toronto and a budding relationship with a rugged Alaskan pilot in this masterful new romance from acclaimed author K.A. Tucker.\n\nCalla Fletcher was two when her mother took her and fled the Alaskan wild, unable to handle the isolation of the extreme, rural lifestyle, leaving behind Calla’s father, Wren Fletcher, in the process. Calla never looked back, and at twenty-six, a busy life in Toronto is all she knows. But when her father reaches out to inform her that his days are numbered, Calla knows that it’s time to make the long trip back to the remote frontier town where she was born.\n\nShe braves the roaming wildlife, the odd daylight hours, the exorbitant prices, and even the occasional—dear God—outhouse, all for the chance to connect with her father: a man who, despite his many faults, she can’t help but care for. While she struggles to adjust to this new subarctic environment, Jonah—the quiet, brooding, and proud Alaskan pilot who keeps her father’s charter plane company operational—can’t imagine calling anywhere else home. And he’s clearly waiting with one hand on the throttle to fly this city girl back to where she belongs, convinced that she’s too pampered to handle the wild.\n\nJonah is probably right, but Calla is determined to prove him wrong. As time passes, she unexpectedly finds herself forming a bond with the burly pilot. As his undercurrent of disapproval dwindles, it’s replaced by friendship—or perhaps something deeper? But Calla is not in Alaska to stay and Jonah will never leave. It would be foolish of her to kindle a romance, to take the same path her parents tried—and failed at—years ago.\n\nIt’s a simple truth that turns out to be not so simple after all.", category: .novela)
    
    static let book3 = Book(title: "The masterpiece", authors: [Storyteller.francineRivers], coverImage: UIImage(named: "image3"), titleKind: .audiobook, category: .novela, rating: 4.5, language: .english, narrators: [Storyteller.narrator1])
    
    static let book4 = Book(title: "The bullet journal method", authors: [Storyteller.ryderCarrol], coverImage: UIImage(named: "image4"), titleKind: .audiobook, category: .crecimientoPersonalYLifestyle)
    
    static let book5 = Book(title: "The ocean at the end of the lane", authors: [Storyteller.neilGaiman], coverImage: UIImage(named: "image5"), titleKind: .audiobook, category: .novela)
    
    static let book6 = Book(title: "The whale road", authors: [Storyteller.robertLow], coverImage: UIImage(named: "image6"), titleKind: .audiobook, category: .novela)
    
    static let book7 = Book(title: "What moves the dead", authors: [Storyteller.kingfisher], coverImage: UIImage(named: "image7"), titleKind: .audiobook, category: .novela)
    
    static let book8 = Book(title: "Milk fed", authors: [Storyteller.melissaBroder], coverImage: UIImage(named: "image8"), titleKind: .audioBookAndEbook, category: .novela)
    
    static let book9 = Book(title: "Kindred", authors: [Storyteller.octaviaButler], coverImage: UIImage(named: "image9"), titleKind: .audiobook, category: .fantasiaYCienciaFiccion)
    
    static let book10 = Book(title: "Brick lane", authors: [Storyteller.monicaAli], coverImage: UIImage(named: "image10"), titleKind: .ebook, category: .novela)
    
    
    
    
    static let book11 = Book(title: "Kodiak", authors: [Storyteller.gellida], coverImage: UIImage(named: "kodiak"), largeCoverImage: UIImage(named: "kodiakLarge"), titleKind: .audioBookAndEbook, category: .novelaNegra)
    
    static let book12 = Book(title: "El resto de tu vida fue ayer", authors: [Storyteller.angelaVallvey], coverImage: UIImage(named: "elRestoDeTuVidaFueAyer"), largeCoverImage: UIImage(named: "elRestoDeTuVidaFueAyerLarge"), titleKind: .audioBookAndEbook, category: .thrillerYHorror)
    
    static let book13 = Book(title: "Julia Menken", authors: [Storyteller.chantalVanMierlo], coverImage: UIImage(named: "juliaMenken"), largeCoverImage: UIImage(named: "juliaMenkenLarge"), titleKind: .audioBookAndEbook, category: .novelaNegra)
    
    static let book14 = Book(title: "Muerte en Padmasana", authors: [Storyteller.susanaMartinGijon], coverImage: UIImage(named: "muerteEnPadmasana"), largeCoverImage: UIImage(named: "muerteEnPadmasanaLarge"), titleKind: .audioBookAndEbook, category: .novelaNegra)
    
    static let book15 = Book(title: "Bogalusa", authors: [Storyteller.pabloToledo], coverImage: UIImage(named: "bogalusa"), largeCoverImage: UIImage(named: "bogalusaLarge"), titleKind: .audioBookAndEbook, category: .novelaNegra)
    
    static let book16 = Book(title: "No olvides mi nombre", authors: [Storyteller.pabloToledo], coverImage: UIImage(named: "noOlvidesMiNombre"), largeCoverImage: UIImage(named: "noOlvidesMiNombreLarge"), titleKind: .audioBookAndEbook, category: .novela)
    
    static let book17 = Book(title: "Odisea", authors: [Storyteller.pabloToledo], coverImage: UIImage(named: "odisea"), largeCoverImage: UIImage(named: "odiseaLarge"), titleKind: .audioBookAndEbook, category: .clasicos)
    
    static let book18 = Book(title: "Desajuste de cuentas", authors: [Storyteller.pabloToledo], coverImage: UIImage(named: "desajusteDeCuentas"), largeCoverImage: UIImage(named: "desajusteDeCuentasLarge"), titleKind: .audioBookAndEbook, category: .novelaNegra)
    
    static let book19 = Book(title: "La suelta", authors: [Storyteller.pabloToledo], coverImage: UIImage(named: "laSuelta"), largeCoverImage: UIImage(named: "laSueltaLarge"), titleKind: .audiobook, category: .thrillerYHorror)
    
    static let book20 = Book(title: "Sixteenth Summer", authors: [Storyteller.pabloToledo, Storyteller.author1, Storyteller.author3], coverImage: UIImage(named: "sixteenthSummer"), titleKind: .ebook, overview: "Anna is dreading another tourist-filled summer on Dune Island that follows the same routine: beach, ice cream, friends, repeat. That is, until she locks eyes with Will, the gorgeous and sweet guy visiting from New York. Soon, her summer is filled with flirtatious fun as Anna falls head over heels in love.\nBut with every perfect afternoon, sweet kiss, and walk on the beach, Anna can’t ignore that the days are quickly growing shorter, and Will has to leave at the end of August. Anna’s never felt anything like this before, but when forever isn’t even a possibility, one summer doesn’t feel worth the promise of her heart breaking…", category: .juvenilYYoungAdult, rating: 3.0, language: .english)
    
    static let book21 = Book(title: "Todos quieren a Daisy Jones", authors: [Storyteller.pabloToledo], coverImage: UIImage(named: "image21"), titleKind: .ebook, overview: "Tiene el mundo a sus pies, pero todo se le va de las manos.\nElla es la estrella del rock más importante del planeta.\nTodos tienen una opinión sobre ella.\nTodos sueñan con ella.\nTodos buscan ser como ella.\nTodos quieren algo de ella.\n'No soy la musa de alguien. No soy una musa. Soy ese alguien.'\nTodos quieren a Daisy Jones.\n\n'Devoré esta novela en un día. Daisy conquistó mi corazón.'\nReese Witherspoon\nBestseller de The New York Times", category: .novela, rating: 4.3, translators: ["Lucía Barahona"], tags: Tag.tags)
    
    static let book22 = Book(title: "La travesía final", authors: [Storyteller.pabloToledo], coverImage: UIImage(named: "image22"), titleKind: .ebook, category: .novela, rating: 4.7, tags: Tag.threeTags)
    
    static let book23 = Book(title: "El hombre nacido en Danzig", authors: [Storyteller.pabloToledo], coverImage: UIImage(named: "image23"), titleKind: .ebook, overview: "Riquelme, el detective, es un tipo gris pero eficiente que no está convencido de revelar los resultados de sus investigaciones. Su cliente, protagonista de esa novela, es un hombre doliente y confundido porque su mujer, Elisa Miller, lo ha abandonado. Elena, Mónica, Sonia, son las sombras que atormentan con sus apariciones al desubicado personaje. Séneca, Schopenhauer y Weininger, pero también el jugador de basquetbol Magic Johnson, son las voces que agitan la conciencia del hombre cada vez que éste sostiene diálogos con sus héroes morales y deportivos.", category: .novela, rating: 0.0, tags: Tag.fourTags)
