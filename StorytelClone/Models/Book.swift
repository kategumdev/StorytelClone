    ...
    static func createBooksFromEbooks(_ ebooks: [Ebook]?) -> [Book] {
        ...
        for ebook in unwrappedEbooks {
            ...
            let book = Book(
                ...
                coverImage: nil,
                titleKind: .ebook,
                description: ebook.volumeInfo.description ?? "This book has no description",
                category: .ebooks,
