...
//        self.date = date
    ...
    static let book3 = Book(id: "03", title: "The masterpiece", authors: [Storyteller.francineRivers], coverImage: UIImage(named: "image3"), titleKind: .audiobook, category: .novela, rating: 4.5, language: "English", narrators: [Storyteller.narrator1])
    
    static let book4 = Book(id: "04", title: "The bullet journal method", authors: [Storyteller.ryderCarrol], coverImage: UIImage(named: "image4"), titleKind: .audiobook, category: .crecimientoPersonalYLifestyle)
    
    static let book5 = Book(id: "05", title: "The ocean at the end of the lane", authors: [Storyteller.neilGaiman], coverImage: UIImage(named: "image5"), titleKind: .audiobook, category: .novela)
    
    static let book6 = Book(id: "06", title: "The whale road", authors: [Storyteller.robertLow], coverImage: UIImage(named: "image6"), titleKind: .audiobook, category: .novela)
    
    static let book7 = Book(id: "07", title: "What moves the dead", authors: [Storyteller.kingfisher], coverImage: UIImage(named: "image7"), titleKind: .audiobook, category: .novela)
    
    static let book8 = Book(id: "08", title: "Milk fed", authors: [Storyteller.melissaBroder], coverImage: UIImage(named: "image8"), titleKind: .audioBookAndEbook, category: .novela)
    
    static let book9 = Book(id: "09", title: "Kindred", authors: [Storyteller.octaviaButler], coverImage: UIImage(named: "image9"), titleKind: .audiobook, category: .fantasiaYCienciaFiccion)
