...
struct Series: Title {
    ...
    init(title: String, authors: [Storyteller], coverImage: UIImage?, titleKind: TitleKind = .series, category: ButtonCategory, language: Language, numberOfFollowers: Int, books: [Book], narrators: [Storyteller]? = nil, isFollowed: Bool = false) {
        self.title = title
