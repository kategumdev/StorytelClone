...
struct Series: Title {
    ...
    init(title: String, authors: [Author], coverImage: UIImage?, titleKind: TitleKind = .series, category: ButtonCategory, language: Language, numberOfFollowers: Int, books: [Book], narrators: [Narrator]? = nil, isFollowed: Bool = false) {
        self.title = title
    ...
    static let series3 = Series(title: "Gatos salvajes", authors: [Author.author9], coverImage: UIImage(named: "image23"), titleKind: .series, category: .novela, language: .spanish, numberOfFollowers: 500, books: [Book.book23, Book.book21, Book.book2, Book.book3, Book.book14, Book.book9, Book.book19, Book.book8, Book.book4, Book.book20], isFollowed: true)
